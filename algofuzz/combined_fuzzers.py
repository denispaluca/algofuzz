...
class PowerSchedule:
    def __init__(self, exponent: int = 5, coef = 0.5) -> None:
    ...
    def assignEnergy(self, population: Sequence[Seed]) -> None:
        for seed in population:
            ...
            weighted_freqs = self.coef * self.transition_frequency[transition_id] + (1 - self.coef) * self.path_frequency[path_id]
